...
//         delay_counter = 0;
//         hal::u16 t =
//         can->can_perseus::floating_to_fixed_point(bldc->get_reading_position(),
//         6); response->length = 8; response->payload[0] = 0x20 + 0x50;
//         response->payload[1] = static_cast<hal::byte>(t >> 8) & 0xFF; // HIGH
//         BYTE FIRST response->payload[2] = static_cast<hal::byte>(t >> 0) &
//         0xFF;  // LOW BYTE SECOND send = true;
//       }
//       break;
//     }
