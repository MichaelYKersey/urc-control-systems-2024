...
hardware_map_t initialize_platform()
{
  ...
  static pwm16_channel p_a_low = timer2.acquire_pwm16_channel(timer2_pin::pa0);// INLB (A0)
  static advanced_timer<peripheral::timer1> timer1;
  static pwm16_channel p_b_low = timer1.acquire_pwm16_channel(timer1_pin::pa8);// INLB (A0)
